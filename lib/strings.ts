export const strings = {
  ...
  sidebar: {
    ...
    nav: {
      conversations: {
        fetch: { label: "Buscar Conversa", description: "Retorna detalhes por SID" },
        fetchByParticipant: { label: "Buscar por Participante", description: "Lista conversas de um endereço" },
        close: { label: "Fechar Conversas", description: "Fecha conversas ativas por número" },
      },
      taskrouter: {
        assignWorkers: { label: "Atribuir Workers", description: "Adiciona skills a workers por e-mail" },
        createWorkflow: { label: "Criar Workflow", description: "Cria workflow de roteamento via CSV" },
        fetchTask: { label: "Buscar Task", description: "Retorna detalhes de uma task por SID" },
        fetchWorker: { label: "Buscar Worker", description: "Retorna dados de um worker por SID ou e-mail" },
        cancelQueueTasks: { label: "Encerrar Tasks da Fila", description: "Encerra tasks pendentes/reservadas e fecha conversas" },
      },
      config: {
        manageEnvironments: { label: "Gerenciar Ambientes", description: "Cadastre e gerencie credenciais Twilio" },
      },
    },
  },
  dashboard: {
    title: "Switchboard",
    subtitle: "Interface visual para operações Twilio. Selecione uma ferramenta abaixo.",
    tools: {
      conversations: {
        label: "Conversations",
        description:
  ...
  conversations: {
    page: {
      title: "Conversations",
      subtitle: "Feche conversas ativas em lote e consulte detalhes de conversas por SID.",
    },
    fetch: {
      breadcrumb: "Buscar Conversa",
      title: "Buscar Conversa por SID",
      subtitle: "Retorna estado, participantes, atributos e datas de uma conversa",
    ...
    close: {
      ...
      subtitle: "Recebe números de telefone e fecha todas as conversas ativas associadas em lote",
      phoneLabel: "Números de telefone",
      phoneLabelHint: "(DDD + número, sem dígito 9 — um por linha ou separados por vírgula)",
    ...
    fetchByParticipant: {
      ...
      results: {
        ...
        noneFiltered: (state: string) => `Nenhuma conversa com estado "${state}" encontrada.`,
  ...
  taskrouter: {
    page: {
      title: "TaskRouter",
      subtitle: "Atribua workers, crie workflows, consulte tasks e inspecione workers do TaskRouter.",
    },
    assignWorkers: {
      breadcrumb: "Atribuir Workers",
      title: "Atribuir Workers à Fila",
      subtitle: "Adiciona uma skill com nível opcional aos attributes de workers identificados por e-mail",
    ...
    createWorkflow: {
      ...
      confirmDescription: (name: string, workspaceSid: string, csvName: string) =>
    ...
    fetchTask: {
      ...
      title: "Buscar Task",
      subtitle: "Retorna status, fila, prioridade, atributos e datas de uma task pelo SID",
      workspaceSidLabel: "Workspace SID",
    ...
    fetchWorker: {
      ...
      title: "Buscar Worker",
      subtitle: "Retorna atividade, skills, atributos e datas de um worker pelo SID ou e-mail",
      workspaceSidLabel: "Workspace SID",
    ...
    cancelQueueTasks: {
      ...
      subtitle: "Encerra tasks pendentes/reservadas, envia mensagem de aviso e fecha as conversas associadas",
      workspaceSidLabel: "Workspace SID",
  ...
  environments: {
    page: {
      ...
      tools: {
        manage: {
          ...
          description: "Cadastre, edite e remova ambientes Twilio com Account SID e Auth Token.",
        },
      },
    },
    manager: {
      ...
      deleteConfirm: (name: string) => `Excluir "${name}"? Esta ação não pode ser desfeita.`,
    ...
    form: {
      ...
      accountSidLabel: "Account SID",
      accountSidHint: "Começa com AC, seguido de 32 caracteres hex — total 34 chars",
